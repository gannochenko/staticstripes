...
Milestone 4: implement the DAG runner. It should traverse the DAG and execute nodes in the right order, passing outputs to inputs, till the end. If an error is encountered in one of the nodes, the execution stops.
